...
switch ($dt['kode_koord_penyuluh']){
	case 1 : $namakoord = $dt['namapns'];break;
	case 2 : $namakoord = $dt['namathl'];break;
	case 3 : $namakoord = $dt['koord_lainya_nama'];break;
	default : $namakoord = '';break;	
}
...
$table = '<table id="listpeg" border="0" width="100%"  cellpadding="2">
	...
	<tr>
      <td width="43%">BIdang Kelembagaan (Sesuai Nomenklatur)</td>
	  <td width="2%">:</td>
      <td width="55%">'.$dtbidang.'</td>	  
    </tr>
    <tr>
...
$table ='
<div bgcolor="#CCCCCC"><strong>II. DATA PENYULUH PERTANIAN PNS KABUPATEN</strong></div><br>';
...
$table ='
<div bgcolor="#CCCCCC"><strong>III. DATA PENYULUH PERTANIAN THL APBN KABUPATEN</strong></div><br>';

$no = 0;
$table .= ' <table width="100%" border="1"  cellpadding="5">
          <tr>
            <td width="5%" align="center">No</td>
            <td width="25%" align="center">No KTP </td>
            <td width="70%" align="center">Nama</td>
          </tr>
		  ';
	if ($jum_thl > 0){
		foreach ($datathl as $row => $thl) { 
			$table .= '
				<tr>
					<td align="left">'.++$no.'</td>
					<td align="center">'.$thl['noktp'].'</td>
					<td align="left">'.trim($thl['gelar_dpn'].' '.$thl['nama'].' '.$thl['gelar_blk']).'</td>		
		...
		$table .= '<tr>
			...
			<td align="center" colspan="3">Belum ada data penyuluh THL APBN</td>         
          </tr>';
	} 	
...
$table ='
<div bgcolor="#CCCCCC"><strong>IV. DATA PENYULUH PERTANIAN THL APBD KABUPATEN</strong></div><br>';
...
$table .= ' <table width="100%" border="1"  cellpadding="5">
		  ...
		  ';
	if ($jum_thl_apbd > 0){
		foreach ($datathl_apbd as $row => $thl) { 
			$table .= '
				<tr>
					<td align="left">'.++$no.'</td>
					<td align="center">'.$thl['noktp'].'</td>
		...
		$table .= '<tr>
			...
			<td align="center" colspan="3">Belum ada data penyuluh THL APBD</td>         
          </tr>';
	} 	
...
$table ='
<div bgcolor="#CCCCCC"><strong>V. DATA PENYULUH PERTANIAN PPPK PROVINSI</strong></div><br>';
