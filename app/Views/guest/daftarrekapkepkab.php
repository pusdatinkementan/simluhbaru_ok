...
<center>
    <h4>
Kelembagaan Pelaku Utama (KEP) Per Kabupaten/Kota </h4><br>
</center>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                            <a href="<?= base_url('/daftarrekapkepkec?kode_kab=' . $item['id_dati2']) ?>" style="color: blue;">
