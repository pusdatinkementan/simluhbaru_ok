    ...
    <div class="table-responsive">
        <table class="table align-items-center mb-0">
            ...
            <tbody>
                ...
                foreach ($rgjumlahanggotakec as $row => $item) if ($item['thl_apbd'] && $item['jum_pemula'] != 0) {
                ?>
                    <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                            <a href="<?= base_url('/rekap_jumlahanggotapoktandesa?kode_kec=' . $item['kode_kec']) ?>" style="color: blue;">
