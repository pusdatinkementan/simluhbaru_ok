    ...
    <div class="table-responsive">
        <table class="table align-items-center mb-0">
            ...
            <tbody>
                ...
                $jum_nik_diantara = 0;
                $jum_nik_lebih = 0;
                foreach ($rgprovdetaildesalist as $row => $item) {
                ?>
                    <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                            <a href="<?= base_url('/rekap_genprovanggota?id_poktan=' . $item['id_poktan']) ?>" style="color: blue;">
                                <p class="text-xs font-weight-bold mb-0" style="text-align: left;"><?= $item['jum_total'] ?></p>
                            </a>
                        </td>
                        <td class="align-middle text-center text-sm">
