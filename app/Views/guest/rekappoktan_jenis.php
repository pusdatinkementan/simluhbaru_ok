    ...
    <div class="table-responsive">
        <table class="table align-items-center mb-0">
            ...
            <tbody>
                ...
                $jum_umkm = 0;
                $jum_know = 0;
                foreach ($rgjenispok as $row => $item) {
                ?>
                    <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                            <a href="<?= base_url('/rekap_jenispoktankab?kode_prop=' . $item['kode_prop']) ?>" style="color: blue;">
                        ...
                        <td class="align-middle text-center text-sm">
                            <a href="<?= base_url('/rekap_jenispoktanexcel?kode_prop=' . $item['kode_prop']) ?>" style="color: blue;">
                                <p class="text-xs font-weight-bold mb-0" style="text-align: left;"><?= $item['jum_tp'] ?></p>
                            </a>
                        </td>
                        <td class="align-middle text-center text-sm">
                        ...
                        <td class="align-middle text-center text-sm">
                            <a href="<?= base_url('/rekap_jenispoktanexcelnak?kode_prop=' . $item['kode_prop']) ?>" style="color: blue;">
                                <p class="text-xs font-weight-bold mb-0" style="text-align: left;"><?= $item['jum_nak'] ?></p>
                            </a>
                        </td>
                        <td class="align-middle text-center text-sm">
