        ...
        <table class="table align-items-center mb-0">
            <thead>
                <tr>
                    ...
                    <td width=170 align=center class="text-uppercase text-secondary text-xxs font-weight-bolder">Kecamatan</td>
            ...
            <tbody>
                ...
                foreach ($rgjumlahanggotadesa as $row => $item) if ($item['thl_apbd'] && $item['jum_pemula'] != 0) {
                ?>
                    <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                            <a href="<?= base_url('/rekap_jumlahanggotapoktandesalist?kode_desa=' . $item['kode_desa']) ?>" style="color: blue;">
                        ...
                        <?php
                        $persen = $item['jum_pemula'] / $item['thl_apbd'] * 100;
                ...
                <?php
                    ...
                    $persen_total = $jum_pemula / $thl_apbd * 100;
