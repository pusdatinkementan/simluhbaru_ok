    ...
    <div class="table-responsive">
        <table class="table align-items-center mb-0">
            ...
            <tbody>
                ...
                foreach ($rgjumlahanggotakab as $row => $item) if ($item['jumpoktan'] && $item['jum_pemula'] != 0) {
                ?>
                    <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                            <a href="<?= base_url('/rekap_jumlahanggotapoktankec?kode_kab=' . $item['kode_kab']) ?>" style="color: blue;">
                        ...
                        <?php
                        $persen = $item['jum_pemula'] / $item['jumpoktan'] * 100;
