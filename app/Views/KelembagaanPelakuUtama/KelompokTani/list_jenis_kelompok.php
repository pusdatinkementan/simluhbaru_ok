...
<div class="card">
    <div class="table-responsive">
        <table id="tblKelompok" class="table align-items-center mb-0">
            <thead>
                <tr>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder" style="text-align: center;">No</th>
                    <th class="text-uppercase text-secondary text-xxs font-weight-bolder" style="text-align: center;">Nama Jenis Kelompok</th>
                ...
                ?>
                    <tr>
                        ...
                        <td class="align-middle text-sm">
                            <p class="text-xs font-weight-bold mb-0"><?= $row['jns_kel'] ?></p>
                        </td>

                        <td class="align-middle text-center text-sm">

                            <button type="button" data-id="<?= $row['id_list'] ?>" id="btnEdit" class="btn bg-gradient-warning btn-sm">
                                <i class="fas fa-edit"></i> Ubah
                            </button>
                            <button class="btn btn-danger btn-sm" id="btnHapus" data-id="<?= $row['id_list'] ?>" type="button">
            ...
            <div class="modal-body">
                <form>
                    <div class="form-group">
                        ...
                        <select name="idkel" id="idkel" class="form-control">
                            <option value="">Pilih</option>
                            <?php
                            foreach ($dtkelompok as $row) {
                            ?>
                                <option value="<?= $row['id_kel']; ?>"><?= $row['jns_kel']; ?></option>
                            <?php } ?>
...
<script>
    $(document).ready(function() {
        ...
        $(document).delegate('#btnSave', 'click', function() {
            ...
            $.ajax({
                url: '<?= base_url('/KelembagaanPelakuUtama/KelompokTani/ListJnsKel/save'); ?>',
                type: 'POST',
                data: {
                    'id_poktan': id_poktan,
                    'idkel': idkel,
