                    ...
                    <table id="listkep" class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder" style="text-align: center;">Nama Kelembagaan <br> Ekonomi</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder" style="text-align: center;">Jenis Kelembagaan <br> Ekonomi</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder" style="text-align: center;">Nama Dir/Ketua</th>
                                ...
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder" style="text-align: center;">Akta <br> Badan Hukum</th>
                                <th class="text-uppercase text-secondary text-xxs font-weight-bolder" style="text-align: center;">Jumlah <br> Pemegang Saham</th>
                                    ...
                                    <td class="align-middle text-sm">
                                        <div class="dropdown show">
                                            ...
                                            <div class="dropdown-menu" aria-labelledby="dropdownMenuLink">
                                                <a class="dropdown-item" href="<?= base_url('/kegiatanbun?id_kep=' . $row['id_kep']) ?>"><i class="fas fa-plus"></i> Tambah Kegiatan Usaha</a>
                                                <a class="dropdown-item" data-id_kep="<?= $row['id_kep'] ?>" id="btnEditKEP" href="#"> <i class="fas fa-edit"></i> Ubah</a>
                                                <a class="dropdown-item" id="btnHapus" data-id_kep="<?= $row['id_kep'] ?>" href="#"><i class="fas fa-trash"></i> Hapus</a>
                                            </div>
