            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                            <p class="text-xs font-weight-bold mb-0"><a href="<?= base_url('profil/PenyuluhPppkProvinsi/detail/' . $row['noktp']) ?>"><?= $row['noktp'] ?></a></p>
                        </td>
                        <td class="align-middle text-center text-sm">
                        ...
                        <td class="align-middle text-center text-sm">
                            <p class="text-xs font-weight-bold mb-0">Kec.<?= ucwords(strtolower($row['kabupaten_tugas'])) ?></p>
                        </td>
                ...
                <div class="modal-content">
                    <div class="modal-body p-0">
                        <div class="card card-plain">
                            ...
                            <div class="card-body">
                                <form role="form text-left" method="POST" action="<?= base_url('Penyuluh/PenyuluhPppkProvinsi/save/'); ?>">
                                    <div class="row">
                                        <div class="col">
                                        ...
                                        <div class="col">
										 <label>Bidang Keahlian</label>
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" name="kode_kab" id="kode_kab" class="form-control" readonly="readonly" value="Provinsi" aria-label="Password" aria-describedby="password-addon">
                                            </div>
                                            <div id="form22">
...
<script>
    $(document).ready(function() {
        ...
        $(document).delegate('#btnSave', 'click', function() {
            ...
            $.ajax({
                url: '<?= base_url() ?>/Penyuluh/PenyuluhPppkProvinsi/save/',
                type: 'POST',
                data: {
                    'nip': nip,
                    'nama': nama,
        ...
        $(document).delegate('#btnHapus', 'click', function() {
            Swal.fire({
                ...
                if (result.value) {
                    ...
                    $.ajax({
                        url: '<?= base_url() ?>/Penyuluh/PenyuluhPppkProvinsi/delete/' + id,
                        type: 'POST',
        ...
        $(document).delegate('#btnEdit', 'click', function() {
            $.ajax({
                url: '<?= base_url() ?>/Penyuluh/PenyuluhPppkProvinsi/edit/' + $(this).data('id'),
                type: 'GET',
                dataType: 'JSON',
                success: function(result) {
                    // console.log(result);
                    ...
                    $(document).delegate('#btnDoEdit', 'click', function() {
                        ...
                        $.ajax({
                            url: '<?= base_url() ?>/Penyuluh/PenyuluhPppkProvinsi/update/' + id,
                            type: "POST",
                            data: formData,
                            cache: false,
                            processData: false,
