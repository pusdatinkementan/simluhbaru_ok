...
<div class="container-fluid py-4">
    <div class="row">
        ...
        <div class="col-xs-12 col-md-12 col-lg-12 mb-4">
			...
			<b>Daftar Penyuluh PNS Nonaktif Provinsi <?= ucwords(strtolower($nama_provinsi)) ?></b>
                    ...
                    <table class="table align-items-center mb-0">
                        <thead>
                            <tr>
                                ...
                                <th class="text-center text-uppercase text-secondary text-xxs font-weight-bolder opacity-7">NIP/NIK</th>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        <p class="text-xs font-weight-bold mb-0"><a href="<?= base_url('profil/penyuluh/detail/' . $row['nip']) ?>"><?= $row['nip'].' / '.$row['noktp'] ?></a></p>
                                    </td>
                                    ...
                                    <td class="align-middle text-center text-sm">
                                        <p class="text-xs font-weight-bold mb-0"><?= $row['nama_bakor'] ?></p>
                                    </td>
                                    <td class="align-middle text-center text-sm">
                                        <p class="text-xs font-weight-bold mb-0"><?= ucwords(strtolower($row['kabupaten_tugas'])) ?></p>
                                    </td>
                                ...
                                <div class="modal-body p-0">
                                    <div class="card card-plain">
                                        <div class="card-header pb-0 text-left">
                                            <h4 class="font-weight-bolder text-warning text-gradient" id="judul">Tambah Data</h4>
                                        </div>
                                        <div class="card-body">
                                            <form role="form text-left" method="POST" action="<?= base_url('Penyuluh/PenyuluhPnsProvinsi/save/'); ?>">
                                                <div class="row">
                                                    <div class="col">
                                                        ...
                                                        ?>
                                                            <input type="hidden" name="unit_kerja" id="unit_kerja" value="<?= $cek1['unit_kerja']; ?>">
                                                        <?php
                                                        }
                                                        ?>
                                                        <?php
													...
													<div class="col">
                                                        ...
                                                        <div class="input-group mb-3">
                                                            <input type="text" name="kode_kab" id="kode_kab" value="Provinsi" readonly="readonly" class="form-control"  aria-label="Password" aria-describedby="password-addon">
                                                        </div>
                                                        <div id="form22">
                                                            <label>Kabupaten 1</label>
                                                            <div class="input-group mb-3">
                                                                <select name="kabupaten_tugas1" id="kabupaten_tugas1" class="form-control input-lg kabupaten_tugas1">
                                                                    <option value="">Pilih Kabupaten</option>
                                                                    <?php
                                                                    foreach ($tugas as $row2) {
                                                                        echo '<option value="' . $row2["id_dati2"] . '">' . $row2["nama_dati2"] . '</option>';
                                                                    }
                                                                    ?>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div id="form13">
                                                            <label>Kabupaten 2</label>
                                                            <div class="input-group mb-3">
                                                                <select name="kabupaten_tugas2" id="kabupaten_tugas2" class="form-control input-lg kabupaten_tugas2">
                                                                    <option value="">Pilih Kabupaten</option>
                                                                    <?php
                                                                    foreach ($tugas as $row5) {
                                                                       echo '<option value="' . $row5["id_dati2"] . '">' . $row5["nama_dati2"] . '</option>';
                                                                    }
                                                                    ?>
                                                                </select>
                                                            </div>
                                                        ...
                                                        <div id="form14">
                                                            <label>Kabupaten 3</label>
                                                            <div class="input-group mb-3">
                                                                <select name="kabupaten_tugas3" id="kabupaten_tugas3" class="form-control input-lg kabupaten_tugas3">
                                                                    <option value="">Pilih Kabupaten</option>
                                                                    <?php
                                                                    foreach ($tugas as $row6) {
                                                                         echo '<option value="' . $row6["id_dati2"] . '">' . $row6["nama_dati2"] . '</option>';
                                                                    }
                                                                    ?>
                                                                </select>
                                                            </div>
                            ...
                            <div class="modal-content">
                                <div class="modal-body p-0">
                                    <div class="card card-plain">
                                        ...
                                        <div class="card-body">
                                            <form method="POST" action="<?= base_url('Penyuluh/PenyuluhPnsProvinsi/updatestatus'); ?>">
                                                <? csrf_field(); ?>
                                                <div class="row">
                                                    <div class="col">
                                                        <input type="hidden" name="id" id="id" class="form-control id">
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).delegate('#btnSave', 'click', function() {
                ...
                var kabupaten_tugas1 = $('#kabupaten_tugas1').val();
                var kabupaten_tugas2 = $('#kabupaten_tugas2').val();
                var kabupaten_tugas3 = $('#kabupaten_tugas3').val();
                ...
                $.ajax({
                    url: '<?= base_url() ?>/Penyuluh/PenyuluhPnsProvinsi/save/',
                    type: 'POST',
                    data: {
                        'nip': nip,
                        'nama': nama,
            ...
            $(document).delegate('#btnHapus', 'click', function() {
                Swal.fire({
                    ...
                    if (result.value) {
                        ...
                        $.ajax({
                            url: '<?= base_url() ?>/Penyuluh/PenyuluhPnsProvinsi/delete/' + id,
                            type: 'POST',
            ...
            $(document).delegate('#btnEdit', 'click', function() {
                $.ajax({
                    url: '<?= base_url() ?>/Penyuluh/PenyuluhPnsProvinsi/edit/' + $(this).data('id'),
                    type: 'GET',
                    dataType: 'JSON',
                    success: function(result) {
                        // console.log(result);
						...
						//alert(result.jenis_kelamin);
                        if (result.jenis_kelamin == "1") {
                            $("#jenis_kelamin1").prop("checked", true);
                        } else {
                            $("#jenis_kelamin1").prop("checked", false);
                        }
                        ...
                        $('#kabupaten_tugas1').val(result.kabupaten_tugas1);
                        $('#kabupaten_tugas2').val(result.kabupaten_tugas2);
                        $('#kabupaten_tugas3').val(result.kabupaten_tugas3);
                        ...
                        $(document).delegate('#btnDoEdit', 'click', function() {
                            ...
                            formData.append('kabupaten_tugas1', kabupaten_tugas1);
                            formData.append('kabupaten_tugas2', kabupaten_tugas2);
                            formData.append('kabupaten_tugas3', kabupaten_tugas3);
                            ...
                            $.ajax({
                                url: '<?= base_url() ?>/Penyuluh/PenyuluhPnsProvinsi/update/' + id,
                                type: "POST",
                                data: formData,
                                cache: false,
                                processData: false,
            ...
            $('.tempat_tugas').on('change', function() {
                ...
                $.ajax({
                    url: "<?= base_url() ?>/Penyuluh/PenyuluhPnsProvinsi/showDesa/" + kdtempat_tugas + "",
    ...
    <script>
        $(document).ready(function() {
            ...
            $(document).delegate('#btnEditStatus', 'click', function() {
                $.ajax({
                    url: '<?= base_url() ?>/Penyuluh/PenyuluhPnsProvinsi/editstatus/' + $(this).data('id'),
                    type: 'GET',
                    dataType: 'JSON',
                    success: function(result) {
                       // console.log(result);
...
alert('haee');
                            ...
                            $.ajax({
                                url: '<?= base_url() ?>/Penyuluh/PenyuluhPnsProvinsi/updatestatus/' + id,
                                type: "POST",
                                data: formData,
                                cache: false,
                                processData: false,
