...
<center>
    <h3>Daftar Penyuluh PPPK Kab <?= ucwords(strtolower($nama_kabupaten)) ?></h3>
    ...
    <div class="row">
        ...
        <div class="row">    
			...
			<div class="row" id="filter" style="display:none">
					...
					<div class="col-md-4">
						<form method="POST" action="<?= base_url('Penyuluh/PenyuluhPPPK/viewfilter'); ?>">
...
<div class="card">
    <div class="table-responsive">
        <table id="tblpppk" class="table align-items-center mb-0">
            <thead>
                <tr>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col">
                                            ...
                                            <div class="input-group mb-3 select-date2">
                                                <input type="text" id="tgl_skcpns" name="tgl_skcpns" class="form-control" placeholder="Tgl SK PPPK">
                                            </div>
                ...
                <div class="modal-content">
                    <div class="modal-body p-0">
                        <div class="card card-plain">
                            ...
                            <div class="card-body">
                                <form method="POST" action="<?= base_url('Penyuluh/PenyuluhPPPK/updatestatus'); ?>">
                                    <? csrf_field(); ?>
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="text" id="tgl_status" name="tgl_status" class="form-control" placeholder="Tgl SK PPPK">
                                            </div>
                                        </div>
                                        <label>Status</label>
                                        <div class="input-group mb-3">
...
<script>
    ...
    $(document).ready(function() {
        ...
        var input_id = 0;
        $('#tblpppk thead td').each( function () {
            var title = $(this).text();
            if(title != ''){
...
<script>
    $(document).ready(function() {
        ...
        $(document).delegate('#btnEditStatus', 'click', function() {
            $.ajax({
                url: '<?= base_url() ?>/Penyuluh/PenyuluhPPPK/editstatus/' + $(this).data('id'),
                type: 'GET',
                dataType: 'JSON',
                success: function(result) {
                    // console.log(result);
                    ...
                    $(document).delegate('#btnDoEditStatus', 'click', function() {
                        ...
                        $.ajax({
                            url: '<?= base_url() ?>/Penyuluh/PenyuluhPPPK/updatestatus/' + id,
                            type: "POST",
                            data: formData,
                            cache: false,
                            processData: false,
