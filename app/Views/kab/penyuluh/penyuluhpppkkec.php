...
<center>
    <h3>Daftar Penyuluh PPPK Kecamatan <?= ucwords(strtolower($nama_kecamatan)) ?></h3>
            ...
            <tbody>
                ...
                ?>
                    <tr>
                        ...
                        <td class="align-middle text-center text-sm">
                            <p class="text-xs font-weight-bold mb-0"><a href="<?= base_url('profil/penyuluhpppkkec/detail/' . $row['nip']) ?>"><?= $row['nip'] ?> / <?= $row['nip_lama'] ?></p>
                        </td>
                        <td class="align-middle text-center text-sm">
                                    ...
                                    <div class="row">
                                        <div class="col">
                                            ...
                                            <div class="input-group mb-3">
                                                <input type="number" class="form-control" placeholder="Penulisan NIP disambung (tanpa tanda pemisah)" aria-label="Email" aria-describedby="email-addon" maxlength="18" oninput="NipOnly(this)">
                                            </div>
                                            <label>NIK (16 Digit)</label>
                                            <div class="input-group mb-3">
                                                <input type="number" class="form-control" placeholder="Penulisan NIK disambung (tanpa tanda pemisah)" aria-label="Password" aria-describedby="password-addon" maxlength="16" oninput="NikOnly(this)">
                                            </div>
                                        ...
                                        <div class="text-center">
                                            ...
                                            <button type="button" class="btn btn-round bg-gradient-info btn-sm">Simpan Data</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
