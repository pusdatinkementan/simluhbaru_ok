...
class PenyuluhPPPKKecModel extends Model
{
    ...
    public function getPenyuluhPPPKKecTotal($kode_kec)
    {
        ...
        $query   = $db->query("select a.noktp, a.nip, a.nip_lama, a.nama, a.gelar_dpn, a.gelar_blk, a.tgl_update, k.nama_bpp,
    ...
    public function getDetailPenyuluhPPPKKecByNIK($nip)
    {
        $db = Database::connect();
